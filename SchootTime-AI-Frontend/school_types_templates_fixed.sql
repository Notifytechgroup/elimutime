...
8, 30, 5, '08:00', '12:30', 
'[{"afterPeriod": 2, "duration": 15, "label": "Short Break"}, {"afterPeriod": 4, "duration": 20, "label": "Long Break"}]',
'{"subjects": ["Mathematics", "English", "Kiswahili", "Science", "Social Studies", "CRE/IRE", "PE", "Art & Music"], "gradeLevels": ["Grade 1", "Grade 2", "Grade 3"], "features": ["Simple timetable", "Shorter periods", "More breaks", "Basic subjects"]}',
NOW(), NOW()),
...
8, 40, 5, '08:00', '15:30',
'[{"afterPeriod": 2, "duration": 15, "label": "Short Break"}, {"afterPeriod": 4, "duration": 30, "label": "Lunch Break"}]',
'{"subjects": ["Mathematics", "English", "Kiswahili", "Science", "Social Studies", "CRE/IRE", "Agriculture", "Business Studies", "PE", "Art & Music"], "gradeLevels": ["Grade 4", "Grade 5", "Grade 6", "Grade 7", "Grade 8"], "features": ["Full subject range", "Standard periods", "Lunch break", "KCPE preparation"]}',
NOW(), NOW()),
...
9, 40, 5, '08:00', '16:00',
'[{"afterPeriod": 2, "duration": 15, "label": "Short Break"}, {"afterPeriod": 5, "duration": 40, "label": "Lunch Break"}]',
'{"subjects": ["Mathematics", "English", "Kiswahili", "Physics", "Chemistry", "Biology", "History", "Geography", "CRE/IRE", "Business Studies", "Agriculture", "Computer Studies"], "gradeLevels": ["Form 1", "Form 2", "Form 3"], "features": ["Science labs", "Specialized subjects", "Longer school day", "KCSE preparation"]}',
NOW(), NOW()),
...
10, 40, 5, '08:00', '17:00',
'[{"afterPeriod": 2, "duration": 15, "label": "Short Break"}, {"afterPeriod": 5, "duration": 40, "label": "Lunch Break"}, {"afterPeriod": 8, "duration": 15, "label": "Evening Break"}]',
'{"subjects": ["Mathematics", "English", "Kiswahili", "Physics", "Chemistry", "Biology", "History", "Geography", "CRE/IRE", "Business Studies", "Agriculture", "Computer Studies", "Home Science"], "gradeLevels": ["Form 4", "Form 5"], "features": ["Elective subjects", "Extended hours", "Exam preparation", "Career guidance"]}',
NOW(), NOW()),
...
8, 45, 5, '08:30', '16:30',
'[{"afterPeriod": 2, "duration": 20, "label": "Morning Break"}, {"afterPeriod": 5, "duration": 60, "label": "Lunch Break"}]',
'{"subjects": ["Mathematics", "English Language", "English Literature", "Physics", "Chemistry", "Biology", "History", "Geography", "Economics", "Business Studies", "Computer Science", "Art & Design", "Physical Education"], "gradeLevels": ["Year 7", "Year 8", "Year 9", "Year 10", "Year 11"], "features": ["International curriculum", "Longer periods", "Modern subjects", "Flexible scheduling"]}',
NOW(), NOW()),
...
6, 60, 5, '09:00', '17:00',
'[{"afterPeriod": 2, "duration": 30, "label": "Coffee Break"}, {"afterPeriod": 4, "duration": 90, "label": "Lunch Break"}]',
'{"subjects": ["Core Courses", "Electives", "Lab Sessions", "Seminars", "Study Periods", "Extra-Curricular"], "gradeLevels": ["Year 1", "Year 2", "Year 3", "Year 4"], "features": ["Flexible scheduling", "Longer periods", "Self-study time", "Professional focus"]}',
NOW(), NOW()),
...
8, 50, 5, '08:00', '17:00',
'[{"afterPeriod": 2, "duration": 20, "label": "Break"}, {"afterPeriod": 5, "duration": 60, "label": "Lunch & Workshop"}]',
'{"subjects": ["Technical Skills", "Practical Sessions", "Theory Classes", "Workshop Time", "Industry Projects", "Certification Prep"], "gradeLevels": ["Level 1", "Level 2", "Level 3"], "features": ["Hands-on training", "Workshop integration", "Industry focus", "Certification ready"]}',
NOW(), NOW());
